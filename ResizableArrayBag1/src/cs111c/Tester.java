...
/** Tester class test all the method and number of 
  *entries and size of the bag
 * @author Jiadong Yu
 * @version 1.1
 * @since 08/30/2016
 */
public class Tester
{
	...
	{
	  // A bag whose initial capacity is 40
      BagInterface<String> aBag = new ResizableArrayBag<String>(20);
      testIsEmpty(aBag, true);
      
      // print out the size of the bag
      System.out.println("The bag size is:" + aBag.arraySize());
	  System.out.println("Adding to the bag more strings than its initial capacity.");
	  //add 14 strings
      String[] contentsOfBag = {"A", "D", "B", "A", "C", "A", "D","A", "D", "B", "A", "C", "A", "D"};
	...
	private static void testRemove(BagInterface<String> aBag, String[] tests)
	{
      for (int index = 0; index < tests.length; index++)
      {
         ...
         if (aString.equals("") || (aString == null))
         {
            ...
            // test if the bag size will reduce after we remove most of strings
            System.out.println("The bag size is:" + aBag.arraySize());
         }
         else
         {
