...
public class Main // Undirected, weighted
{
    ...
    public static void testBartStation(){
    	UndirectedGraph<String> myBartStation = new UndirectedGraph<String>();
    	StackInterface<String> stops1 = new LinkedStack<>();
    	StackInterface<String> stops2 = new LinkedStack<>();
    	StackInterface<String> stops3 = new LinkedStack<>();
    	
    	myBartStation.addVertex("Pittsburg");
    	myBartStation.addVertex("MacArthur");
    	myBartStation.addVertex("19th St");
    	myBartStation.addVertex("12th St");
    	myBartStation.addVertex("Richmond");
    	myBartStation.addVertex("Embarcadero");
    	myBartStation.addVertex("24th St");
    	myBartStation.addVertex("Millbrae");
    	myBartStation.addVertex("Fremont");
    	myBartStation.addVertex("Dublin");
    	myBartStation.addVertex("BayFair");
    	myBartStation.addVertex("Coliseum");
    	myBartStation.addVertex("Oakland Airport");
    	myBartStation.addVertex("Balboa Park");
    	
    	myBartStation.addEdge("Millbrae","Balboa Park");
    	myBartStation.addEdge("Balboa Park","24th St");
    	myBartStation.addEdge("24th St","Embarcadero");
    	myBartStation.addEdge("Embarcadero","12th St");
    	myBartStation.addEdge("12th St","19th St");
    	myBartStation.addEdge("19th St","MacArthur");
    	myBartStation.addEdge("MacArthur","Pittsburg");
    	myBartStation.addEdge("MacArthur","Richmond");
    	myBartStation.addEdge("Embarcadero","Coliseum");
    	myBartStation.addEdge("Coliseum","BayFair");
    	myBartStation.addEdge("BayFair","Dublin");
    	myBartStation.addEdge("BayFair","Fremont");
    	myBartStation.addEdge("Coliseum","Oakland Airport");
    	myBartStation.addEdge("12th St","Coliseum");
    	
    	myBartStation.getShortestPath("Millbrae", "Pittsburg", stops1);
    	myBartStation.getShortestPath("Richmond", "Dublin", stops2);
    	myBartStation.getShortestPath("Fremont", "Oakland Airport", stops3);

        System.out.println("\nMillbrae to Pittsburg Station will stop at :");
        displayStack(stops1);
        
        System.out.println("\nRichmond to Dubin Station will stop at :");
        displayStack(stops2);
        
        System.out.println("\nFremont to Oakland Airport Station will stop at :");
        displayStack(stops3);
